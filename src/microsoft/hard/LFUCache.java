...
public class LFUCache {
    ...
    Elements get sorted in the same sequence in which they have
    ...
    public void put(int key, int value) {
        ...
        if (keyToVal.size() >= capacity)
            ...
            Also, we used iterator.next() since the least recently+frequently used value to be removed is the first
            element in LinkedHashSet with the lowest count/frequency.
            */
